import { ITEMS, COLUMNS, state } from "./data.js";
...
/**
 * Since the items in use, and their identification can be configured before
 ...
 * items and creates the HTML to select them.
 *
 * @returns {HTMLElement}
 */
const createTableOptionsHtml = () => {
  ...
  for (const singleTable of ITEMS) {
